...
function PopUpMessage({message, typeInfo}) {
  ...
  return (
    <>
      ...
      >
        ...
        <Modal.Body>
          {typeInfo == 0 ? (
            <p>La subcategoría se eliminó correctamente</p>
          ) : typeInfo == 1 ? (
            <p>La subcategoría no se pudo eliminar</p>
          ) : (
            <p>La subcategoría no se pudo eliminar porque tiene libros asociados</p>
          )}
        </Modal.Body>
        <Modal.Footer>
